				...
				<div className="mx-auto grid max-w-6xl gap-12 px-6 py-20 lg:grid-cols-12">
					...
					<div className="lg:col-span-7">
						<p className="text-lg text-muted-foreground md:text-xl">
							The 2026 Conference returns for its second year. Expect a tight day of programming
							focused on founders building real, durable businesses — not a parade of pitch decks.
							Programming, speakers, and tickets are maintained on Eventbrite.
						</p>
			...
			<section className="border-t border-border">
				<div className="mx-auto max-w-6xl px-6 py-20">
					<div className="mb-10">
						...
						<h2 className="font-serif text-3xl md:text-4xl">A day designed for builders.</h2>
					</div>
				...
				<div className="mx-auto max-w-6xl px-6 py-20">
					<div className="mb-10 flex items-end justify-between gap-6">
						<div>
							...
							<h2 className="font-serif text-3xl md:text-4xl">Six tracks we're building around.</h2>
						</div>
						<p className="hidden max-w-sm text-sm text-muted-foreground md:block">
							Final session titles, speakers, and rooms land on Eventbrite as they're confirmed.
						</p>
					</div>
				...
				<div className="mx-auto grid max-w-6xl gap-12 px-6 py-20 lg:grid-cols-12">
					<div className="lg:col-span-4">
						...
						<p className="mt-4 text-sm text-muted-foreground">
							The exact schedule, speakers, and room assignments will be published on Eventbrite as
							they're finalized.
						</p>
					</div>
					<div className="lg:col-span-8">
						<ol className="divide-y divide-border overflow-hidden rounded-xl border border-border bg-card">
							{AGENDA.map((s) => (
								<li key={s.time} className="flex items-baseline justify-between gap-6 px-6 py-4">
