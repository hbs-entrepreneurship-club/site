					...
					<div className="lg:col-span-7">
						...
						<ul className="mt-6 space-y-4 text-lg text-muted-foreground">
							<li className="flex gap-3">
								<span className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-crimson" />A roster of
								HBS founders to trade tactics, intros, and warm leads with.
							</li>
							<li className="flex gap-3">
							...
							<li className="flex gap-3">
								<span className="mt-2 h-1.5 w-1.5 shrink-0 rounded-full bg-crimson" />A shared
								playbook for building cash-flow-positive businesses on real constraints.
							</li>
						</ul>
					</div>
